...
const californiaPopulation = _.sumBy(californiaCities, 'population');
console.log(californiaCities)

// GROUP BY PARTY AND SHOW ONLY CITIES WITH A POPULATION ABOVE 1 MILLION. SORT CITY NAMES ALPHABETICALLY
const filteredCities = _.filter(cities, city => city.population > 1000000);
const sortedCities2 = _.sortBy(filteredCities, 'city');
const groupedByParty = _.groupBy(sortedCities2, 'party');
